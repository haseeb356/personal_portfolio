...
export const Navbar: React.FC<NavbarProps> = ({ isDarkMode }) => {
  ...
  return (
    <>
      ...
      <header
        className={`fixed top-4 left-0 right-0 z-40 px-4 sm:px-6 transition-all duration-300 ${
          scrolled ? 'py-1' : 'py-3'
        }`}
      >
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-slate-400 -mt-1 font-sans font-medium">
                  UET Lahore
                </span>
              </div>
            </a>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <a
                ...
                rel="noreferrer"
                id="btn-nav-whatsapp"
                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs sm:text-sm font-bold text-slate-950 bg-emerald-400 hover:bg-emerald-300 shadow-[0_0_16px_rgba(52,211,153,0.4)] transition-all duration-200 hover:scale-[1.03] active:scale-[0.98]"
              >
          ...
          <AnimatePresence>
            {mobileMenuOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className={`md:hidden mt-2 p-4 rounded-2xl border shadow-2xl ${
                  isDarkMode
